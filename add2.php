...
//ทำการเพิ่มข้อมูล
try {
    $sql = "INSERT INTO pets (name, breed, gender, age)
    VALUES ('$name', '$breed', '$gender','$age' )";
    // use exec() because no results are returned
    $conn->exec($sql);
    echo " <div class='alert alert-success'> <strong>บันทึกข้อมูลสำเร็จ!</strong> ยินดีด้วย คุณได้บันทึกข้อมูลเข้าไปใหม่ 1 รายการ </div>";
